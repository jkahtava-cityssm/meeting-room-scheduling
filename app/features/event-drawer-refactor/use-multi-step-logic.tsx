...
export const useMultiStepFormLogic = (props: {
	...
	const defaultFormValues = useMemo(() => {
		...
		if (props.creationDate) return getFormDefaults(props.creationDate, props.userId, config?.interval, props.roomId);

		return getFormDefaults(undefined, props.userId, config?.interval, props.roomId);
