...
export const DailyTimeBlocks = React.memo(function DailyTimeBlocks({
  ...
  return (
    <ScrollArea className="max-h-[50vh] md:max-h-[60vh] lg:max-h-[70vh] xl:max-h-[73vh] w-full" type="always">
...
const TimeBlockEventDrawer = ({
  ...
  return allowCreateEvent ? (
    <EventDrawer creationDate={getDateTime(currentDate, hour, startMinute)} userId={userId} roomId={roomId}>
