...
import { isRequirementMet } from "@/lib/api-helpers";

export function AppSidebar({ ...props }: React.ComponentProps<typeof Sidebar>) {
	const { session, isPending } = useClientSession();
	const ReadCalendar = useVerifySessionRequirement(session, { type: "permission", resource: "ReservationCalendar", action: "Read" });
