...
import { CheckIcon, XCircle, ChevronDown, XIcon, WandSparkles, LucideFilter, LucideX, LucideTrash2 } from "lucide-react";
...
export const MultiSelect = React.forwardRef<MultiSelectRef, MultiSelectProps>(
	(
		...
		const { containerRef, shadowRef, actionsRef, measurementLimit, visibleCount } = useOverflowDetection(selectedValues.length);
...
const ClearButton = ({ onClick, totalSelected, isFocused }: { onClick: () => void; totalSelected: number; isFocused: boolean }) => (
	<div
		role="button"
		tabIndex={-1}
		onClick={e => {
...
const OptionItem = React.memo(
	function OptionItem({ option, isSelected, onToggle }: { option: MultiSelectOption; isSelected: boolean; onToggle: (value: string) => void }) {
