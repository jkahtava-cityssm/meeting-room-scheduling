...
export const CONFIGURATION_KEYS = ["visibleHoursStart", "visibleHoursEnd", "timeSlotIntervalMinutes", "singleSignOnEnabled"] as const;
...
export const DEFAULT_PERMISSION_SETS: DEFAULT_PERMISSION_SET[] = [
	{
		...
		SET: [
			...
			{ RESOURCE: "My Bookings", ACTIONS: ["Create", "Read", "Update", "Delete"] },
	...
	},
	{
		...
		SET: [
			...
			{ RESOURCE: "My Bookings", ACTIONS: ["Create", "Read"] },
