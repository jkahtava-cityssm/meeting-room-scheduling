...
export const queryKeys = {
  ...
  events: {
    ...
    status: (start: string, end: string, statusId: string) => [...queryKeys.events.statuses(start, end), statusId] as const,
  ...
  users: {
    ...
    profile: (id: string | undefined) => [...queryKeys.users.all, 'user_profile', id],
